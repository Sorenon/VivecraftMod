package org.vivecraft.client.vr.gameplay.screenhandlers;

import org.vivecraft.client.ClientDataHolder;
import org.vivecraft.client.vr.provider.ControllerType;
import org.vivecraft.utils.lwjgl.Matrix4f;
import org.vivecraft.client.vr.gui.GuiKeyboard;
import org.vivecraft.client.vr.gui.PhysicalKeyboard;
...
public class KeyboardHandler
{
    ...
    public static org.vivecraft.utils.math.Matrix4f Rotation_room = new org.vivecraft.utils.math.Matrix4f();
    ...
    public static void orientOverlay(boolean guiRelative)
    {
        ...
        if (Showing)
        {
            ...
            if (dh.vrSettings.physicalKeyboard)
            {
                ...
                Rotation_room = org.vivecraft.utils.math.Matrix4f.rotationY(f);
                Rotation_room = org.vivecraft.utils.math.Matrix4f.multiply(Rotation_room, Utils.rotationXMatrix(2.5132742F));
            }
            ...
            else
            {
                ...
                Rotation_room = org.vivecraft.utils.math.Matrix4f.rotationY(f2);
            }
        }
    }
